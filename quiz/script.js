...
const scorecount=document.getElementById('scount')
...
submitBtn.addEventListener('click', () => {
    ...
    scorecount.innerText=`the current score is : ${score}`
    questioncount.innerText=`You have attempted ${currentQuiz} no. of questions`
